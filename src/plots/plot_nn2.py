...
class Neuron():
    ...
    def draw(self, neuron_radius):
        ...
        if self.placeholder:
            pyplot.gca().text(self.x, self.y, "[...]", fontsize=20, ha="center", va="center")
...
class Layer():
    def __init__(self, network, number_of_neurons, number_of_neurons_in_widest_layer):
        ...
        self.number_of_neurons = number_of_neurons if number_of_neurons % 2 == 0 else number_of_neurons - 1

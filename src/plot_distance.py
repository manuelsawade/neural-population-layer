...
cmap = cm.get_cmap("YlOrRd")   # plasma goes from dark->warm; good for hot mapping
...
# Plot both distributions
ax.plot(x, preferred_values, 'o', color='black', label='Preferred Value', markersize=6)
ax.plot(x, input_values, 'x', color='gray', label='Input Value', markersize=6)
...
ax.set_xlabel("Hidden Layer Neurons")
ax.set_ylabel("Value")
ax.set_title("Distance inverted Activation")
